...
CREATE TABLE IF NOT EXISTS `mobil` (
  ...
  `lampiran` char(10) NOT NULL,
  `hal_surat` char(4) NOT NULL,
  `tglsurat_dibuat` int(8) NOT NULL,
  `tujuan_surat` char(10) DEFAULT NULL,
...
INSERT INTO `mobil` (`id_surat`, `lampiran`, `hal_surat`, `tglsurat_dibuat`, `tujuan_surat`) VALUES
...
INSERT INTO `sewa` (`nokw`, `tglsewa`, `id_surat`, `nopen`, `lama`, `bayar`) VALUES
