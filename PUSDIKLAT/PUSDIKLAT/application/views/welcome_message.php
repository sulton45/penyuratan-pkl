...
<html lang="en">
  <head>
    ...
    <title>PUSDIKLAT PERPUSNAS RI</title>
  </head>
  <body>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="#">Unit A</a>
...
<!--       <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search"> -->
      <button class="btn btn-outline-success my-2 my-sm-0 btn btn-outline-dark" type="submit">Login</button>
    </form>
  </div>
</nav>
