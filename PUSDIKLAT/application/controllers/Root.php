...
class Root extends CI_Controller
{
	...
	public function pdf($nim)
	{
		...
		foreach ($data as $data_surat) {
			...
			$pdf->Cell(34, 1, date_indo(date('Y-m-d', strtotime($data_surat->tgl_dibuat))), 0, 1,);
			...
			$pdf->MultiCell(160, 1, "Menindaklanjuti Surat Saudara Nomor " . $data_surat->no_surat . " tanggal " . date_indo(date('Y-m-d', strtotime($data_surat->tglsurat_pemohon))) . " dengan ini disampaikan bahwa kami bersedia menerima " . "Mahasiswa" . " Saudara yaitu:", 0, 'L', 0, 0, '', '', true, 0, false, true, 40);
